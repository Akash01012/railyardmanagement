...
def create_device(device_id,partner_id, unique_id, device_type,wagons_obj):
    if(device_type == "Wagon"):
        ...
        print("Please choose the currect type...........")
...
class ControlRoom:
    ...
    def receive_command_response(self,sender):
        print(f"received the list from Engine: {sender.originator_id}")
    
    def send_command(self,command):
        print(f"Sending {command} command to everyone")
